...
Learning a new trick can save a lot of time. With the basic setup done it is now very easy to use more modern web development tools like [Less](http://lesscss.org/) instead of CSS and [TypeScript](https://www.typescriptlang.org/) instead of JavaScript. The gulp website lists [many plugins](https://gulpjs.com/plugins/) that solve almost any problem related to modern web development.